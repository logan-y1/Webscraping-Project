...
#Read the exel file 'ProduceReport.xlsx 
# write all the contents of this file into Second Sheet in current workbook 

# display the grand total and average of 'amt sold' and 'total' 
# at the bottom of the list alond with appropriate lables
